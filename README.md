...
You have to design & build the backend for the application and the ability for the users to register, direct messages, join channels etc.
...
https://github.com/azaylamba/slack 
